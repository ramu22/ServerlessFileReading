...
void main() {
    ...
    vec4 colors[8];
    colors[0] = vec4(0.6,0.3,1.0,1.0);      // saturation = 0
    colors[1] = vec4(0.6,0.3,1.0,1.0);      // H 0
    colors[2] = vec4(0.6,0.3,1.0,1.0);      // H 30
    colors[3] = vec4(0.6,0.3,1.0,1.0);      // H 60
    colors[4] = vec4(0.6,0.3,1.0,1.0);      // H 120
    colors[5] = vec4(0.6,0.3,1.0,1.0);      // H 180
    colors[6] = vec4(0.6,0.3,1.0,1.0);      // H 240
    colors[7] = vec4(1.0,1.0,1.0,1.0);      // H 280
